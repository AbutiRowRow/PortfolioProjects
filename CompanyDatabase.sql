...
-- find forname and surname of all employees
...
-- fund number of employees

SELECT COUNT(emp_id)
FROM employee;

-- number of females born after 1970
SELECT COUNT(emp_id)
FROM employee
WHERE sex = 'F' AND birth_day > '1971-01-01';

-- Average of all the salary
SELECT AVG(salary)
FROM employee
WHERE sex = 'M';
...
-- how may males and females are there
...
-- Find branch supplier in the labbel business
...
-- find all clients who are handled by the branche that Michael Scott manages
